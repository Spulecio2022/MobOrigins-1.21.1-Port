...
public class OriginSlimeGelLayer<T extends OriginSlimeEntity>
        extends RenderLayer<T, OriginSlimeModel<T>> {

    public OriginSlimeGelLayer(RenderLayerParent<T, OriginSlimeModel<T>> parent) {
        super(parent);
    }
    ...
    public void render(PoseStack poseStack,
        ...
        this.getParentModel().root().render(
                poseStack,
                consumer,
                packedLight,
