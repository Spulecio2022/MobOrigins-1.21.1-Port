...
public class ModifyReputationPower extends ValueModifyingPowerType {

    private final BiEntityCondition biEntityCondition;

    public ModifyReputationPower(
    ...
    public boolean doesApply(Entity villager, LivingEntity holder) {
        return biEntityCondition == null || biEntityCondition.test(villager, holder);
    }

    // -------------------------
    // DATA FACTORY
    // -------------------------
    public static final TypedDataObjectFactory<ModifyReputationPower> DATA_FACTORY =
            TypedDataObjectFactory.simple(
                    ...
                    data -> {
                        ...
                        return new ModifyReputationPower(cond, mods);
                    },
    ...
    public static final PowerConfiguration<PowerType> CONFIG =
            (PowerConfiguration<PowerType>) (PowerConfiguration<?>)
                    PowerConfiguration.of(
                            MobOriginsMod.id("modify_villager_reputation"),
                            DATA_FACTORY
                    );
